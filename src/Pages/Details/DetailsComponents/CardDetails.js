        ...
        <div>
            <div className="p-5 mx-auto sm:p-10 md:p-16 bg-gray-100 text-gray-800">
                <div className="flex flex-col  mx-auto overflow-hidden ">
                    <img src={img} alt="" className=" w-full lg:max-w-4xl mx-auto shadow-2xl rounded-lg" />
                    <div className="md:p-6 pb-12 lg:-mt-52 space-y-6 max-w-full sm:px-10 lg:rounded-md bg-gray-50 text-justify shadow-2xl">
