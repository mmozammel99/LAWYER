...
const ContactUs = () => {
    ...
    return (
        <div className={`${dark?"bg-base-200":"bg-primary" } shadow my-5`}>
            <div className={`space-y-2 text-center py-5  `} >
                ...
                <div className= {`${!dark?"text-base-100":"text-gray-100" }`}>Law is complicate matter. It can cause you a big problem
